var App;
(function (App) {
    var LevelFourContentDatabase = (function () {
        function LevelFourContentDatabase() {
            this.LevelFourContent = {
                "LevelFourContent1": {
                    "Id": "Volunteer Drivers",
                    "Description": "When students leave the building for school-sponsored events, safe transportation is a critical responsibility. Sometimes we may use volunteer drivers to transport students.\
        ...
        return LevelFourContentDatabase;
    }());
    App.LevelFourContentDatabase = LevelFourContentDatabase;
})(App || (App = {}));
//# sourceMappingURL=levelFourContent.js.map